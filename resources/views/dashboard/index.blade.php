                        ...
                        <div class="card shadow-sm border-0 rounded-lg">
                            ...
                            <div class="card-body p-3">
                                <div class="factory-floor-container position-relative">
                                    <div class="factory-floor d-flex" style="min-width: 980px; gap: 16px;">
                                        
                                        <!-- Left Side: Main Lanes (A, B, C) -->
                                        <div class="d-flex flex-column" style="flex: 1; gap: 16px;">
                                            ...
                                            <div class="floor-row-wrapper">
                                                ...
                                                <div class="floor-row">
                                                    ...
                                                    <div class="machine-node mc-broken" style="margin-left: 6px; border-left: 1px solid #cbd5e1; padding-left: 6px;"><svg viewBox="0 0 120 50" style="width: 100%; height: 20px; display: block; margin: 0 auto 2px auto;"><rect x="10" y="22" width="6" height="16" rx="1" fill="currentColor"/><line x1="16" y1="25" x2="45" y2="25" stroke="currentColor" stroke-width="2"/><line x1="16" y1="35" x2="45" y2="35" stroke="currentColor" stroke-width="2"/><rect x="22" y="19" width="6" height="22" rx="1" fill="currentColor" opacity="0.8"/><rect x="32" y="17" width="10" height="26" rx="2" fill="currentColor"/><rect x="46" y="17" width="8" height="26" rx="1" fill="currentColor"/><polygon points="72,8 84,8 78,19" fill="currentColor"/><rect x="54" y="22" width="38" height="10" rx="1" fill="currentColor"/><rect x="92" y="24" width="12" height="6" rx="1" fill="currentColor" opacity="0.6"/><rect x="5" y="42" width="104" height="6" rx="2" fill="currentColor" opacity="0.5"/></svg>JD-1001<span class="mach-code">Broken</span></div>
                                                    @for($i=2; $i<=11; $i++)
                                            ...
                                            <div class="floor-row-wrapper">
                                                ...
                                                <div class="floor-row">
                                                    ...
                                                    <div class="d-flex flex-column align-items-center justify-content-center" style="border: 1px solid #cbd5e1; border-radius: 50%; width: 58px; height: 52px; font-size: 7px; text-align: center; background: #fff; line-height: 1.1; margin: 0 4px; flex-shrink: 0; box-shadow: inset 0 1px 3px rgba(0,0,0,0.05); color: #475569; font-weight: 700;">
                                                        BLOW
                                                    </div>
                                        ...
                                        <!-- Right Side: Mold Storage Columns (8 Green, 4 Red) -->
                                        <div class="d-flex flex-column" style="width: 130px; border-left: 1px dashed #cbd5e1; padding-left: 10px; gap: 10px; flex-shrink: 0;">
                                            <div class="floor-row-label">Mold Storage</div>
                                            <div class="d-flex" style="gap: 8px; background: rgba(148, 163, 184, 0.03); padding: 6px; border-radius: 6px; border: 1px solid #e2e8f0; flex-grow: 1; align-items: start;">
                                                <!-- Col 1 -->
                                                <div class="d-flex flex-column" style="gap: 4px; flex: 1;">
                                                    @for($i=1; $i<=4; $i++)
                                                        <div class="machine-node mc-active w-100" style="height: 38px;"><svg viewBox="0 0 120 50" style="width: 100%; height: 14px; display: block; margin: 0 auto;"><rect x="10" y="22" width="6" height="16" rx="1" fill="currentColor"/><line x1="16" y1="25" x2="45" y2="25" stroke="currentColor" stroke-width="2"/><line x1="16" y1="35" x2="45" y2="35" stroke="currentColor" stroke-width="2"/><rect x="22" y="19" width="6" height="22" rx="1" fill="currentColor" opacity="0.8"/><rect x="32" y="17" width="10" height="26" rx="2" fill="currentColor"/><rect x="46" y="17" width="8" height="26" rx="1" fill="currentColor"/><polygon points="72,8 84,8 78,19" fill="currentColor"/><rect x="54" y="22" width="38" height="10" rx="1" fill="currentColor"/><rect x="92" y="24" width="12" height="6" rx="1" fill="currentColor" opacity="0.6"/><rect x="5" y="42" width="104" height="6" rx="2" fill="currentColor" opacity="0.5"/></svg><span class="mach-code" style="font-size: 5px;">MS-A{{$i}}</span></div>
                                                    @endfor
                                                    @for($i=1; $i<=2; $i++)
                                                        <div class="machine-node mc-broken w-100" style="height: 38px;"><svg viewBox="0 0 120 50" style="width: 100%; height: 14px; display: block; margin: 0 auto;"><rect x="10" y="22" width="6" height="16" rx="1" fill="currentColor"/><line x1="16" y1="25" x2="45" y2="25" stroke="currentColor" stroke-width="2"/><line x1="16" y1="35" x2="45" y2="35" stroke="currentColor" stroke-width="2"/><rect x="22" y="19" width="6" height="22" rx="1" fill="currentColor" opacity="0.8"/><rect x="32" y="17" width="10" height="26" rx="2" fill="currentColor"/><rect x="46" y="17" width="8" height="26" rx="1" fill="currentColor"/><polygon points="72,8 84,8 78,19" fill="currentColor"/><rect x="54" y="22" width="38" height="10" rx="1" fill="currentColor"/><rect x="92" y="24" width="12" height="6" rx="1" fill="currentColor" opacity="0.6"/><rect x="5" y="42" width="104" height="6" rx="2" fill="currentColor" opacity="0.5"/></svg><span class="mach-code" style="font-size: 5px;">MS-B{{$i}}</span></div>
                                                    @endfor
                                                </div>
                                                <!-- Col 2 -->
                                                <div class="d-flex flex-column" style="gap: 4px; flex: 1;">
